...
def Login(uname,passwd):
	...
	#con.commit()
	#con.close()
	FlightDate = ["10 Nov","11 Nov" , "12 Nov"]
	...
	p2=sp.Popen(["./C_login",'1',uname,passwd,flightValues[0],DataValues[0],DataValues[1]])
	
	while 1:
		Login_correct = client_socket.recv(512)
	if (Login_correct == "UserProfile"):
		client_socket.close()
		Userprofile()
	else :
		client_socket.close()
...
while 1:
	...
	choices = ["UserLogin", "AdminLogin","Register/Sign Up"]
